...
//   useEffect(() => {
//     var footerExp = $(".footer-links-wrapper h3");
// footerExp.on("click", function () {
...
//   }, []);
  ...
  // $('.footer-links-wrapper h3').on(function() {
  //     $(this).toggleClass('expanded');
  //   });
      ...
      <div className="container">
        ...
        <div className="row footer-links-wrapper">
          <div className="col col-12 col-sm-6 col-m-4 col-lg-2 offset1">
            ...
            <FooterProps headTitle='Shop and Learn' linkName={['mac','ipad','iphone','watch','tv','music','airpods','homepods','ipod touch','accessories','gift cards']} />
